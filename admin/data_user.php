	...
	$data = mysqli_query($conn,"SELECT*FROM user");
	 ...
	 <div class="container">
	 	...
	 	<section id="menu">
			...
			<article>
				<h2 class="text-cennter">Daftar nama user</h2>
				...
				<table class="table">
					...
					<tr>
						...
						<td><?= $d['role']?></td>
						<td class="action">
							<a class="btn btn-warning" href="../admin/edit_akun.php?id=<?= $d['id_user']?>" onclick="return confirm('Apakah anda ingin mengedit data?')" ><i class="bi bi-pencil-square"></i></a>
							<a class="btn btn-danger" href="../config/act_hapus.php?id=<?= $d['id_user']?>" onclick="return confirm('Apakah anda ingin Hapus data?')"><i class="bi bi-trash-fill"></i></a>
						</td>
					</tr>
				<?php endforeach?>
				</table>
