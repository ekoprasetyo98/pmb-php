...
<html lang="en">
  ...
  <body>
    <div class="container">
      <div class="row login">
        <div class="col-12 col-md-6 col-lg-6 img-login">
          <a href="http://www.freepik.com">
            <img class="img-fluid" src="assets/img/login-img.jpg"></img>
          </a>
          
        </div>

        <div class="col-12 col-md-6 col-lg-5 form-login">
          <form action="config/act_login.php" method="post">
            ...
            <button type="submit" name="submit" class="btn btn-primary pl-4 pr-4 mt-3">Login</button>
          </form>
